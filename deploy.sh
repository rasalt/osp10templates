...
openstack overcloud deploy --templates -e /home/stack/templates/advanced-networking.yaml   --compute-flavor compute --control-flavor control --compute-scale 1 --control-scale 1 --ceph-storage-scale 0 --neutron-network-type vlan --neutron-tunnel-types vxlan,vlan --ntp-server pool.ntp.org --neutron-bridge-mappings datacentre:br-ex,tenant:br-vlan --neutron-network-vlan-ranges tenant:30:100
